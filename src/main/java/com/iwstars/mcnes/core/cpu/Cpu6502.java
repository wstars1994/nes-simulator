...
public class Cpu6502{
    ...
    private void runProgram(){
        ...
        while (iterator.hasNext()) {
            ...
            System.out.printf("insNum=%06d cycle=%03d A=$%02X,X=$%02X,Y=$%02X pc=$%02X ",runCycleNum++,cpuCycle,CpuReg.getReg_A()&0xFF,CpuReg.getReg_X()&0xFF,CpuReg.getReg_Y()&0xFF,prgPc&0xFFFF);
            //执行程序(超级玛丽的执行顺序)
            switch(insCode&0xff) {
                //SEI 禁止中断
                case 0x78:
